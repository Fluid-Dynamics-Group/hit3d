...
input_file_name=$1
# location that the /output directory will be moved to
move_location=$2
...
# copy the output directory to the new location
cd ~/github/hit3d/src/
cp -r output/ "$move_location"
cp "$input_file_name.in" "$move_location/$input_file_name.in"
